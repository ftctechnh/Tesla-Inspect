                    ...
                    if (group != null && group.isGroupOwner()) {
                        wifiP2pManagerObj.removeGroup(mChannel, new WifiP2pManager.ActionListener() {
                            ...
                            public void onSuccess() {
                                ...
                                Toast.makeText(InspectionActivity.this, "Successfully disconnected from WiFi Direct",
                                        Toast.LENGTH_SHORT).show();
                            }
                            ...
                            public void onFailure(int reason) {
                                ...
                                Toast.makeText(InspectionActivity.this, "There was an error disconnecting " +
